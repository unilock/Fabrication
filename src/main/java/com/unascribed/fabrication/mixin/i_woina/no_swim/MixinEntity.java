...
public class MixinEntity {
	...
	private static boolean fabrication$disableSwimming(Entity self, Operation<Boolean> original) {
		return (FabConf.isEnabled("*.no_swim") && fabrication$noSwimPredicate.test(self)) ? false : original.call(self);
	}
}
