...
public class MixinEntity {
	...
	private static boolean fabrication$preventFire1(Entity instance, int fireTicks) {
	...
	private static boolean fabrication$preventFire2(Entity instance, float seconds) {
		return !FabConf.isEnabled("*.disable_lightning_burn");
	}
}
