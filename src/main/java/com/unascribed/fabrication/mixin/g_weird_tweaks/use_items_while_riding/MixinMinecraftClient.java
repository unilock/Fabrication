...
public class MixinMinecraftClient {
	@ModifyExpressionValue(method={"doItemUse()V", "doAttack()Z"}, at=@At(value="INVOKE", target="Lnet/minecraft/client/network/ClientPlayerEntity;isRiding()Z"))
	private boolean fabrication$allowUsageWhileRiding(boolean old){
