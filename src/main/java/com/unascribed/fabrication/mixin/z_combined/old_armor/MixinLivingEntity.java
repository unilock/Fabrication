...
public abstract class MixinLivingEntity extends Entity {
	...
	@WrapWithCondition(at=@At(value="INVOKE", target="Lnet/minecraft/item/ItemStack;applyAttributeModifiers(Lnet/minecraft/entity/EquipmentSlot;Ljava/util/function/BiConsumer;)V"),
			method="getEquipmentChanges()Ljava/util/Map;")
	private boolean fabrication$oldArmor(ItemStack stack, EquipmentSlot slot, BiConsumer<RegistryEntry<EntityAttribute>, EntityAttributeModifier> consumer) {
		...
		if (!(((scale && stack.isDamageable()) || old) && stack.getItem() instanceof ArmorItem && ((ArmorItem)stack.getItem()).getSlotType() == slot)) return true;
