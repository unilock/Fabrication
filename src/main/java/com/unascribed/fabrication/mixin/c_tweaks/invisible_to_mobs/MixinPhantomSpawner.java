...
public class MixinPhantomSpawner {
	...
	@WrapOperation(method="spawn(Lnet/minecraft/server/world/ServerWorld;ZZ)I", at=@At(value="INVOKE", target="Lnet/minecraft/server/network/ServerPlayerEntity;isSpectator()Z"))
	private boolean fabrication$InvisTaggablePlayersIsSpectator(ServerPlayerEntity subject, Operation<Boolean> original) {
