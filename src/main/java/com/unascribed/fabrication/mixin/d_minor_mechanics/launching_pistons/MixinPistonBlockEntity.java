...
public class MixinPistonBlockEntity {
	...
	private static boolean fabrication$launchPlayer(BlockState state, Block block, Operation<Boolean> original) {
		return original.call(state, block) || FabConf.isEnabled("*.launching_pistons") && block == Blocks.SLIME_BLOCK;
	}
